(function (g) {
  ...
  function updateOpening(){
    const kid=chosen('awal'),cfg=data.pengaturan.find(c=>c.karyawan_id===kid);$('awal-mulai').disabled=$('awal-masa').disabled=!!cfg;
    $('awal-masa').value='12';
    ...
    }else $('awal-periode').innerHTML='<option value="">Pilih karyawan dan tanggal mulai bekerja</option>';
